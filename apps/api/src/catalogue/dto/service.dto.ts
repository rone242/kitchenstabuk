...
export class CreateServiceDto {
  @IsOptional() @IsString() @MaxLength(500) summaryEn?: string;
  ...
  @IsOptional() @IsString() @MaxLength(320) durationTextEn?: string;
  ...
  @IsOptional()
  @IsEnum(PriceType)
  priceType?: (typeof PriceType)[keyof typeof PriceType];
  ...
  @IsOptional() @IsUUID() coverImageId?: string | null;
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(20)
  @IsUUID('4', { each: true })
